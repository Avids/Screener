    ...
    <div className="wrap">
      ...
      <section className="panel">
        <div className="row">
          ...
          <input value={finnhubKey} onChange={e => setFinnhubKey(e.target.value)} placeholder="Optional - use your Finnhub key" />
        </div>
        <div className="row">
          <label>Polygon API Key</label>
          <input value={polygonKey} onChange={e => setPolygonKey(e.target.value)} placeholder="Optional - use your Polygon key" />
        </div>
      </section>
      ...
      <section className="panel actions">
        ...
        <p className="muted">Provider path: {provider} · {asOf ? `Last scan ${new Date(asOf).toLocaleString()}` : "Not run yet"}</p>
